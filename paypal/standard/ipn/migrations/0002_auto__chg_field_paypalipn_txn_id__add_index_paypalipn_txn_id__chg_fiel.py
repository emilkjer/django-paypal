...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PayPalIPN.parent_txn_id'
        db.alter_column('paypal_ipn', 'parent_txn_id', self.gf('models.CharField')("Parent Transaction ID", max_length=19))

        # User chose to not deal with backwards NULL issues for 'PayPalIPN.ipaddress'
        raise RuntimeError("Cannot reverse this migration. 'PayPalIPN.ipaddress' and its values cannot be restored.")
